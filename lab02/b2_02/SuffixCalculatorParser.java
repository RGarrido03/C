...
public class SuffixCalculatorParser extends Parser {
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(SuffixCalculatorParser.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SuffixCalculatorVisitor)
                return ((SuffixCalculatorVisitor<? extends T>) visitor).visitProgram(this);
    ...
    public static class StatContext extends ParserRuleContext {
        ...
        public TerminalNode NEWLINE() {
            return getToken(SuffixCalculatorParser.NEWLINE, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SuffixCalculatorVisitor)
                return ((SuffixCalculatorVisitor<? extends T>) visitor).visitStat(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprNumberContext extends ExprContext {
        ...
        public TerminalNode Number() {
            return getToken(SuffixCalculatorParser.Number, 0);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SuffixCalculatorListener)
                ((SuffixCalculatorListener) listener).enterExprNumber(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SuffixCalculatorListener)
                ((SuffixCalculatorListener) listener).exitExprNumber(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SuffixCalculatorVisitor)
                return ((SuffixCalculatorVisitor<? extends T>) visitor).visitExprNumber(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExprSuffixContext extends ExprContext {
        ...
        public ExprSuffixContext(ExprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SuffixCalculatorListener)
                ((SuffixCalculatorListener) listener).enterExprSuffix(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SuffixCalculatorListener)
                ((SuffixCalculatorListener) listener).exitExprSuffix(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof SuffixCalculatorVisitor)
                return ((SuffixCalculatorVisitor<? extends T>) visitor).visitExprSuffix(this);
            else return visitor.visitChildren(this);
        }
    }
}